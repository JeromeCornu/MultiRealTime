...
public class OnlinePlayerWeaponsManager : MonoBehaviour
{
    ...
    OnlinePlayerCharacterController m_PlayerCharacterController;
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<OnlinePlayerInputHandler, OnlinePlayerWeaponsManager>(m_InputHandler, this,
            gameObject);

        m_PlayerCharacterController = GetComponent<OnlinePlayerCharacterController>();
        DebugUtility.HandleErrorIfNullGetComponent<OnlinePlayerCharacterController, OnlinePlayerWeaponsManager>(
